...
export class DevicesTableGenericComponent implements OnInit {
  ...
  constructor(private cdRef: ChangeDetectorRef, public matDialog: MatDialog, private pcsData: CloudpcsService, private ngxLoader: NgxUiLoaderService,
    public auth: AdapptAuthServiceService,public snackBar: MatSnackBar,
  ...
  updateProfile(value: any) {
    ...
    this.dashboardService.updateUser(value).subscribe( data => {
